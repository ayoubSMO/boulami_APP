								...
								<table class="table table-striped">
								  ...
								  <tbody>
                                    <tr v-for="user in users" :key="user.id" >
										...
										<td><button  class="btn btn-primary" @click="selectUser(user)"><em class="fa fa-file-o"></em></button></td>
                                    </tr>
...
<userEdit-component  :user="user" :editMethod="editMethod" @toggleEdit="editMethod = !editMethod" v-if="editMethod" ></userEdit-component>
