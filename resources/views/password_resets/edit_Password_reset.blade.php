        ...
        <div class="col-sm-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <!-- Name input-->
                 <password_resetForm-component :oldPassword_reset="password_reset" :editMethod="editMethod"></password_resetForm-component>
                </div>
            </div>
        </div>
        <div class="col-sm-8">
...
<script>
    export default {
        ...
        mounted() {
            console.log('password_reset edit Component mounted.')
        },
        methods: {
            changeValue(){
