								...
								<table class="table table-striped">
								  <thead>
								    <tr>
										...
										<th scope='col'>isAbort</th>
	
								    </tr>
								  </thead>
								  <tbody>
                                    <tr v-for="r_d_v_ in r_d_v_s" :key="r_d_v_.id" >
																			<td>{{r_d_v_.timeslot}}</td>
										<td>{{r_d_v_.isAbort}}</td>
	
										<td><button  class="btn btn-primary" @click="selectR_d_v_(r_d_v_)"><em class="fa fa-file-o"></em></button></td>
                                    </tr>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <r_d_v_Form-component></r_d_v_Form-component>	
...
<r_d_v_Edit-component  :r_d_v_="r_d_v_" :editMethod="editMethod" @toggleEdit="editMethod = !editMethod" v-if="editMethod" ></r_d_v_Edit-component>
...
<script>
    export default {
        ...
        mounted() {
            console.log('r_d_v_ Component mounted.')
        },
        data()
        {
            return {
        ...
        created()
        {
            axios.get('http://localhost:8000/api/r_d_v_s'
            ).then(response => 
                this.r_d_v_s = response.data
