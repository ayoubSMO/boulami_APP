...
@section('content')
    <h1>Create Post</h1>
    {!! Form::open(['action' => 'App\Http\Controllers\DoctorController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        ...
        <div class="form-group">
            ...
            {{Form::text('speciality', '', ['class' => 'form-control', 'placeholder' => ''])}}
        </div>
        <div class="form-group">
            {{Form::label('quote', 'Quote')}}
            {{Form::text('quote', '', ['class' => 'form-control', 'placeholder' => ''])}}
        </div>
        <div class="form-group">
